...
\noindent
I am applying for the tenure-track Professor of Computer Science position advertised on \url{higheredjobs.com}.
I'm currently a postdoc at UC Riverside's Data Science Center,
where my research develops new distributed machine learning algorithms and new programming language features that make machine learning libraries easier to use.
...
%My research makes large-scale machine learning algorithms easier to use,
%with a focus on social media data.
%\fixme{
...
%As an instructor for these courses, I participated in UC Riverside's ABET accreditation process.
