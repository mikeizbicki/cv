...
\noindent
My research directly supports USF's vision to educate students with a ``global perspective'' to help them create ``a more humane and just world.'' 
For example, social media platforms are generating more data everyday from around the world, 
and I develop new large scale learning algorithms designed to better understand this data. 
I've developed some of the first techniques for applying machine learning to the more than 100 non-English languages used daily on Twitter,
and techniques to prevent malicious users from teaching these algorithms to spread racist thoughts or fake news.
...
%I've also developed techniques that prevent prevent malicious users from teaching these algorithms to behave spread racist thoughts or fake news.
...
%On the practical side, I've developed techniques for working with highly multilingual social media text.
%For example, I worked on a project dataset of 1 billion tweets written in more than 100 languages from around the world.
...
I hope at USF to offer a course on open source software development,
